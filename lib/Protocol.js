...
Protocol.prototype.cancel = function cancel(pid, key) {
  if (!this.writable)
    return false;
  var buf = Buffer.allocUnsafe(16);
  buf.writeInt32BE(16, 0, true);
  buf.writeInt32BE(80877102, 4, true);
  buf.writeInt32BE(pid, 8, true);
  buf.writeInt32BE(key, 12, true);
  return this.push(buf);
};
